...
// make aufgabe3_test
// or (same thing):
// g++ -std=c++17 -Wall -pedantic -O3 -D_GLIBCXX_ASSERTIONS -g -fsanitize=address aufgabe3_test.cpp aufgabe3.cpp -o aufgabe3_test
//
#include <iostream>
#include <string>
#include <algorithm>
...
int main()
{
    ...
    std::cout << "(if code is correctly pushed into Git && aufgabe3_main.cpp is correct && your implementation uses MLR )\n";
    std::cout << "\nBonus points are awarded as described in the task sheet.\n";
